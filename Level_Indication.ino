...
/*
  ...
  else if ((level[0] > 0.02) && (level[0] < 0.34)){
    tft.fillRect(206, 106, 31, 294, RA8875_WHITE);
    tft.fillRect(206, scaled_start[0], 31, scaled_extension[0], RA8875_GREEN);
  }
  else if ((level[0] < 0.67) && (level[0] > 0.33)){
    tft.fillRect(206, 106, 31, 294, RA8875_WHITE);
    tft.fillRect(206, scaled_start[0], 31, scaled_extension[0], RA8875_YELLOW);    
    tft.fillRect(206, 302, 31, 98, RA8875_GREEN);
  }
    else if ((level[0] < 1.01) && (level[0] > 0.66)){
    tft.fillRect(206, 106, 31, 294, RA8875_WHITE);
    tft.fillRect(206, scaled_start[0], 31, scaled_extension[0], RA8875_RED);
    tft.fillRect(206, 204, 31, 98, RA8875_YELLOW);    
    tft.fillRect(206, 302, 31, 98, RA8875_GREEN);
  }
 */
